...
public interface BlockRepository extends JpaRepository<Block, Long> {
	...
	@Query("SELECT new com.app.dto.BlockDto(b.id, b.blockNumber) FROM Block b WHERE b.level.id = :levelId and b.blockWidth >= :itemWidth and b.blockLength >= :itemLength")
